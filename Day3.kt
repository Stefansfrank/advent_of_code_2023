...
class Day3 : Solver {
            ...
            for (x in 0 until pdx) {
                ...
                if (pData[y][x].isDigit()) {
                    ...
                    if (prsNum) {
                        ...
                        symbol = symbol || pData.symb(nxtPts(x,y))
                        if (gear == null) gear = pData.gear(nxtPts(x,y))

                    // start of a number
                    } else {
                        prsNum = true
                        symbol = pData.symb(startPts(x,y))
                ...
                // encountered the end of a number
                    ...
                    prsNum = false
                    symbol = symbol || pData.symb(endPts(x,y))
                    ...
                    if (gear != null)
                        gears[gear] = ((gears[gear] ?: listOf()) + num)
                }
            }
        }
    ...
    private fun List<String>.symb(pts:List<XY>) =
